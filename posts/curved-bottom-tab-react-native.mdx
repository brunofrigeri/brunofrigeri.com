...
locale: en
---
At some point, every developer need to fulfill the desire of some design work in a application to built a curved bottom tab. With me wasnt so difference, I cross this path once my design team asks for it, my major difficult was trying to understand how to do it.
