...
The previous developer left to us a linear navigation (using react-navigation), that basically works without different stacks (not differing auth and app). With that in mint, one of our screens was the Status one, that basically could be navigated towards all the application.
...
**Welcome Page**:
![IMG_7834](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/87ps6man6vdo2pb841xt.PNG)

**Status - status_one (after click on onPressFirstStatus)**:
![IMG_7835](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/rucfbx4gmdveipt04x3o.PNG)

**Status - status_two (after click on onPressSecondStatus)**
![IMG_7836](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/936nl6ml72nyi65t0ich.PNG)
